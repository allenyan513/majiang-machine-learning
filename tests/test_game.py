...
from majiang.engine.actions import PASS, Action, ActionType, chi, discard, pon, riichi, ron, tsumo
from majiang.engine.game import Game, Phase
from majiang.engine.hand import Hand, MeldType
from majiang.engine.tile import EAST, counts_from_tiles, parse_hand
...
def test_addkan_chankan():
    ...
    from majiang.engine.hand import Meld
