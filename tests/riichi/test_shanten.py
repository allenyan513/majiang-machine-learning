...
from majiang.riichi.shanten import (
    discard_options,
    effective_tiles,
    seven_pairs_shanten,
    shanten,
...
from majiang.riichi.tile import counts_from_tiles, full_wall, parse_hand
from majiang.riichi.win import is_win, waiting_tiles
...
def test_kokushi_shanten():
    from majiang.riichi.shanten import kokushi_shanten
