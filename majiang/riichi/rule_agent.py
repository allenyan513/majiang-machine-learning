...
from majiang.riichi.game import Observation, Phase
from majiang.riichi.shanten import discard_options
from majiang.riichi.tile import NUM_TILE_TYPES, is_honor, is_terminal
from majiang.riichi.win import waiting_tiles
